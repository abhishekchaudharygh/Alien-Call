...
import com.example.aliencall.databinding.ActivityCallBinding;
import com.example.aliencall.models.InterfaceJava;
...
public class CallActivity extends AppCompatActivity {
    ...
    void listenConnId() {
        firebaseRef.child(aliensUsername).child("connId").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.getValue() == null)
                    return;
